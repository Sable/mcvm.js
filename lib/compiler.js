      ...
      init: {
        ...
        body: {
          ...
          body: function (stmts, inputs, outputs, match) {
            ...
            }).concat(varDeclarations(decls), jsStmts)
...
exports.matlab2JS = function (ast, options) {
  ...
  program.body = esprima.parse(
    // "if (typeof exports !== 'undefined' && typeof _McLib === 'undefined') {" +
    // "  var _McLib = require('./lib/mclib.js')" +
    // '}' +
    'for (var p in _McLib.stdlib) {' +
    '  global[p] = _McLib.stdlib[p]' +
    '}').body.concat(program.body)
